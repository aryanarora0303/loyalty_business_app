...
export function Sidebar() {
    ...
    return (
        <section className="bg-white bg-opacity-0 min-h-full">
            ...
            <div className="flex items-center justify-between xl:hidden border-b border-coolGray-100 py-5">
            ...
            {/* <div class="navbar-menu z-50 fixed top-0 hidden flex xl:flex flex-col justify-between border-r border-coolGray-100 max-w-xs w-9/12 h-full overflow-y-scroll">
                <div className='relative bg-white'>
                    <div className="fixed p-8 max-w-xs">
                        <NavLink className="block" to={ROUTES.DASHBOARD}>
                            <img className='h-20' src="./loyalty_logo.png" alt=""/>
                        </NavLink>
                    </div>
                </div>
            ...
            <div className="navbar-menu z-50 fixed top-0 left-0 hidden flex xl:flex flex-col justify-between bg-white border-r border-coolGray-100 max-w-xs w-9/12 h-full overflow-y-auto">
                <div className="navbar-backdrop fixed xl:hidden inset-0 bg-coolGray-900 opacity-60" />
                <div className="relative bg-white">
                    <div className="fixed p-6 pb-2 max-w-xs w-9/12 z-50 bg-white">
                        {/* <a className="block max-w-max" href="#">
                            <img src="flex-ui-assets/logos/dashboard/flex-ui-black-yellow.svg" alt="" />
                        </a> */}
                        <NavLink className="block max-w-max" to={ROUTES.DASHBOARD}>
                            <img className='h-20' src="./loyalty_logo.png" alt=""/>
                        </NavLink>
                    ...
                    <div className="mt-32">
                        ...
                        <div className="px-4 mb-1">
                            <div>
                                <a className="p-3 py-2 flex items-center justify-between text-coolGray-500 hover:text-yellow-500 hover:bg-coolGray-50 rounded-md" href="#">
                ...
                <div className="relative bg-white">
                    <div className="fixed bottom-0 max-w-xs w-full flex flex-wrap items-center p-6 justify-between bg-white border-r border-coolGray-100">
                        <div className="w-auto">
                            <div className="flex flex-wrap -mx-2">
                                <div className="w-auto p-2 m-auto">
                                    <i className="fa-solid fa-user text-coolGray-500 text-3xl" />
                                </div>
