    ...
    let handleRowClick = (el) => {
        ...
        setTableIndDataRow(
            <tr id={row.bus_id} key={0} className="group border-b border-gray-200 cursor-pointer">
                ...
                <td className="py-2 px-3 bg-white group-hover:bg-coolGray-50 text-sm truncate font-medium text-coolGray-600 text-center transition-all"><img className='h-14 m-auto' src={row.bus_image} alt='business logo'/></td>
